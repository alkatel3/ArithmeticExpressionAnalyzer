...
namespace ArithmeticExpressionOptimizerTest
{
    ...
    public class ArithmeticExpressionOptimizerTest
    {
        ...
        [DataRow("v/a-v/c-v/a", "v*(-1/c)")]
        [DataRow("a*b-c*d", "a*b-c*d")]
        [DataRow("a*(b+c)-a*(d+e)", "a*((c+b)-(e+d))")]
        [DataRow("a*(b+c)-d*(e+f)", "a*(c+b)-d*(f+e)")]
        [DataRow("(y+z)*x+x*(y+z)", "2*x*(z+y)")]
        [DataRow("(a*b+a*c)-(a*d+a*e)", "a*(-(d+e)+b+c)")]
        [DataRow("(x/y+x/z)-(x/w+x/t)", "x*(-(1/w+1/t)+1/y+1/z)")]
        [DataRow("(x*y-x*z)-(x*w-x*t)", "x*(-(z+w)+y+t)")]
        [DataRow("a/b-(a/c-a/d)", "a*(1/b+1/d-1/c)")]
        [DataRow("(a*b+a*c)-(a*d-a*e)", "a*(b+c+e-d)")]
        [DataRow("(x/y+x/z)-(x/t-x/w)", "x*(1/y+1/z+1/w-1/t)")]
        [DataRow("(a+b-c)+(c-d-e)", "-(d+e)+b+a")]
        [DataRow("(a/b-a/c)+(a/d-a/e)", "a*(-(1/c+1/e)+1/b+1/d)")]
        [DataRow("a*(b-c)-(d*(e-f))", "a*(b-c)-d*(e-f)")]
        [DataRow("(a*b-a*c)-(d*e-d*f)", "d*(f-e)+a*(b-c)")]
        [DataRow("a/b-(a/c-(a/d-a/e))", "a*(-(1/c+1/e)+1/b+1/d)")]
        [DataRow("(x/y-x/z)-(x/t-x/w)", "x*(-(1/z+1/t)+1/y+1/w)")]
        [DataRow("((a+b)-(c-d))+((e+f)-(g-h))", "-(c+g)+h+f+e+d+b+a")]
        [DataRow("a*b-c*(d-e)-f*(g+h)", "-(c*(d-e)+f*(h+g))+a*b")]
        [DataRow("(a/b-a/c)-(a/d+a/e)", "a*(-(1/c+1/d+1/e)+1/b)")]
        [DataRow("a*(b-c+d)-e*(f-g+h)", "a*(d+b-c)-e*(h+f-g)")]
        [DataRow("(a*b-a*c)-(d*e-d*f)-(g*h-g*i)", "g*(i-h)+d*(f-e)+a*(b-c)")]
        [DataRow("a*(b-c)*(d+e)-(f/g)*(h-i)", "a*(b-c)*(e+d)-(f/g)*(h-i)")]
        [DataRow("(x/y-x/z)-(a*b-a*c)", "x*(1/y-1/z)+a*(c-b)")]
        [DataRow("(a*(b+c)-d*(e+f))-g*(h+i)", "-(d*(f+e)+g*(i+h))+a*(c+b)")]
        [DataRow("a/b-(a/c-(a/d+(a/e-a/f)))", "a*(-(1/c+1/f)+1/b+1/d+1/e)")]
        [DataRow("((a*b+a*c)-(a*d+a*e))-(a*f+a*g)", "a*(-(d+e+f+g)+b+c)")]
        [DataRow("(x*y+x*z)-(x*w-x*t)-(x/v)", "x*(-(w+1/v)+y+z+t)")]
        [DataRow("a*(b-c-(d-e))-f*(g-h-(i-j))", "a*(-(c+d)+e+b)-f*(-(h+i)+j+g)")]
        [DataRow("x/y+x/y+x/y+x/y", "4*x/y")]

        [DataRow("a*b+a*c+a*d", "a*(b+c+d)")]
        [DataRow("p*q+p*r+p*s", "p*(q+r+s)")]
        [DataRow("x/(y+z)+x/(y+z)", "2*x/(y+z)")]
        [DataRow("v/a+v/c+v/a+v/b+v/a", "v*(3/a+1/c+1/b)")]
        [DataRow("m/n+m/o+m/p+m/q", "m*(1/n+1/o+1/p+1/q)")]
        [DataRow("x*y+x*z+x*w+x*v", "x*(y+z+w+v)")]
        [DataRow("a*b+a*b+a*c+a*c", "a*(2*b+2*c)")]
        [DataRow("p*q+p*r+p*q+p*s", "p*(2*q+r+s)")]
        [DataRow("x/y+x/z+x/w+x/v", "x*(1/y+1/z+1/w+1/v)")]
        [DataRow("a/b+a/c+a/d+a/e", "a*(1/b+1/c+1/d+1/e)")]
        [DataRow("a*b*c+a*b*d+a*b*e", "a*b*(c+d+e)")]
        [DataRow("x/y+x/z+x/w-x/t", "x*(1/y+1/z+1/w-1/t)")]
        [DataRow("x*sin(y)+x*sin(z)+x*sin(w)", "x*(sin(y)+sin(z)+sin(w))")]
        [DataRow("(a*b+c*d)-(e*f+g*h)", "-(e*f+g*h)+c*d+a*b")]
